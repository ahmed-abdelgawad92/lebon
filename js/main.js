...
/////////////////////////////////////////////////////////////////////////
			...
			$(window).scroll(function(){
				if ($(this).scrollTop() > 100) { // this refers to window
					$('#logo').removeClass("app-logo");
					$('#logo').addClass("app-logo-scroll");
					$('#counter').addClass("scroll");
					$('.navbar-header').addClass('scroll');
				}else{
					$('#logo').removeClass("app-logo-scroll");
					$('#logo').addClass("app-logo");
					$('.navbar-header').removeClass('scroll');
					$('#counter').removeClass("scroll");
				}
